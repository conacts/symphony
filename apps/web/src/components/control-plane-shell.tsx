...
export function ControlPlaneShell(input: {
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      <div className="grid min-h-dvh lg:grid-cols-[19rem_minmax(0,1fr)]">
        <aside className="border-b bg-card xl:border-b-0 xl:border-r">
        ...
        <main className="flex flex-col gap-8 p-6 lg:p-10">
          <Card>
            ...
            <CardFooter className="flex flex-col items-start gap-3 border-t pt-6 text-sm text-muted-foreground lg:flex-row lg:items-center lg:justify-between">
