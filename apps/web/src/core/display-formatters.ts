...
const labelOverrides = new Map<string, string>([
  ...
  ["runtime_turn_started", "Runtime turn started"],
  ["runtime_terminal_result_detected", "Terminal result detected"],
  ["runtime_terminal_result_returned", "Terminal result returned"],
  ["runtime_timeout_classified", "Timeout classified"],
  ["runtime_run_completed", "Runtime run completed"],
